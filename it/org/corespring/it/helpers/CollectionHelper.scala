...
object CollectionHelper {
  ...
  def create(organizationId: ObjectId): ObjectId =
    service.insertCollection(orgId = organizationId, ContentCollection(id = new ObjectId, name = Company.name, ownerOrgId = organizationId), Permission.Write, true) match {
