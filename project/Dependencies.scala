...
object Dependencies {
  ...
  //V2 Player
  val containerVersion = "3.3.0-server-stash-SNAPSHOT"
  val qtiVersion = "0.16"
  ...
  val elasticsearchPlayWS = ("org.corespring" %% "elasticsearch-play-ws" % "1.0.0-PLAY22").exclude("org.mongodb", "mongo-java-driver")
