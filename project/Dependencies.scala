...
object Dependencies {
  ...
  //V2 Player
  val containerVersion = "0.42.0-SNAPSHOT-AC-190"
  ...
  val elasticsearchPlayWS = ("org.corespring" %% "elasticsearch-play-ws" % "0.0.12-PLAY22").exclude("org.mongodb",  "mongo-java-driver")
