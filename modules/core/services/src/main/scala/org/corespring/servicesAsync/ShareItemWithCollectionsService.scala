...
trait ShareItemWithCollectionsService {
  ...
  def unShareAllItemsFromCollection(collectionId: ObjectId): Future[Validation[PlatformServiceError, Unit]]
  /**
   ...
   * @return
   */
  def shareItems(orgId: ObjectId, items: Seq[VersionedId[ObjectId]], collId: ObjectId): Future[Validation[PlatformServiceError, Seq[VersionedId[ObjectId]]]]
   ...
   * @return
   */
  def unShareItems(orgId: ObjectId, items: Seq[VersionedId[ObjectId]], collIds: ObjectId*): Future[Validation[PlatformServiceError, Seq[VersionedId[ObjectId]]]]
   ...
   * @return
   */
  def isItemSharedWith(itemId: VersionedId[ObjectId], collId: ObjectId): Future[Boolean]
}
