...
class MockOrgTransformer(val org: Option[Organization] = None, val defaultCollection: Option[ObjectId] = None, val orgId: Validation[String, ObjectId] = Failure("no org id")) extends WithOrgTransformer[String] with Mockito {
