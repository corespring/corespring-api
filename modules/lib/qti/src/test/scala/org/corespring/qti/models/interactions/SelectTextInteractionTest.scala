...
import org.corespring.qti.models.{CorrectResponse, CorrectResponseMultiple, ResponseDeclaration}
...
class SelectTextInteractionTest extends Specification {
  ...
  "Select Text Interaction" should {
    ...
    "too few selection is reflected in response object" in {
      val rd = ResponseDeclaration("selectText", "multiple", "identifier", false, Some(CorrectResponseMultiple(List("2", "3", "7"))), None)
    ...
    "too many selection is reflected in response object" in {
      val rd = ResponseDeclaration("selectText", "multiple", "identifier", false, Some(CorrectResponseMultiple(List("2", "3"))), None)
