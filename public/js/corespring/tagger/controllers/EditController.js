 ...
 */
function EditCtrl($scope, $location, $routeParams, ItemData, $rootScope, Collection, ServiceLookup, $http) {
    ...
    ItemData.get({id:$routeParams.itemId}, function onItemLoaded(itemData) {
...
EditCtrl.$inject = ['$scope', '$location', '$routeParams', 'ItemData', '$rootScope', 'Collection', 'ServiceLookup', '$http'];
