describe('item-edit-button-only', function(){

  beforeEach(module('tagger.directives'));

  var rootScope, compile;

  var div = ['<item-edit-button-only',
  ...
  function mkDirective(s){
    var out = compile(angular.element('<item-edit-button-only org-drafts="orgDrafts">'))(s);
    out.scope().$digest(); 
    return out;
  }
