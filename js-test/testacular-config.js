...
files = [
    ...
    'public/js/corespring/tagger/utils/ArrayUtils.js',
    'public/js/corespring/tagger/app.js',
    'public/js/corespring/tagger/services.js',
    'public/js/corespring/tagger/controllers.js',
    'public/js/corespring/tagger/filters.js',
    'public/js/corespring/tagger/directives.js',
    'js-test/unit/*.js',
    'js-test/unit/select2/*.js',
    'js-test/unit/utils/*.js'
];
