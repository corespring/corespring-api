...
case class FocusTaskInteraction(responseIdentifier: String, choices: Seq[SimpleChoice]) extends InteractionWithChoices{
...
object FocusTaskInteraction extends InteractionCompanion[ChoiceInteraction]{
